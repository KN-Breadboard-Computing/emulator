...
int load_config_temp(Config *config) {
    ...
    config->instructions[0b00001101]->num_operands = 2;
    strcpy(config->instructions[0b00001101]->mnemonic, "MOV");
    config->instructions[0b00001101]->operands = (char **)malloc(sizeof(char *) * 2);
    config->instructions[0b00001101]->operands[0] = (char *)malloc(sizeof(char) * 2);
    config->instructions[0b00001101]->operands[1] = (char *)malloc(sizeof(char) * 6);
    strcpy(config->instructions[0b00001101]->operands[0], "A");
    strcpy(config->instructions[0b00001101]->operands[1], "CONST");
    // MOVBIMM
    ...
    config->instructions[0b00001110]->num_operands = 2;
    strcpy(config->instructions[0b00001110]->mnemonic, "MOV");
    config->instructions[0b00001110]->operands = (char **)malloc(sizeof(char *) * 2);
    config->instructions[0b00001110]->operands[0] = (char *)malloc(sizeof(char) * 2);
    config->instructions[0b00001110]->operands[1] = (char *)malloc(sizeof(char) * 6);
    strcpy(config->instructions[0b00001110]->operands[0], "B");
    strcpy(config->instructions[0b00001110]->operands[1], "CONST");
    // HALT
    ...
    strcpy(config->instructions[0b00011010]->operands[0], "A");
    // ADDB
    config->instructions[0b00011011] = (Instruction *)malloc(sizeof(Instruction));
    config->instructions[0b00011011]->mnemonic = (char *)malloc(sizeof(char) * 4);
    config->instructions[0b00011011]->num_operands = 1;
    strcpy(config->instructions[0b00011011]->mnemonic, "ADD");
    config->instructions[0b00011011]->operands = (char **)malloc(sizeof(char *));
    config->instructions[0b00011011]->operands[0] = (char *)malloc(sizeof(char) * 2);
    strcpy(config->instructions[0b00011011]->operands[0], "B");
    // SUBABA
    ...
    // SUBBAA
    config->instructions[0b00100000] = (Instruction *)malloc(sizeof(Instruction));
    config->instructions[0b00100000]->mnemonic = (char *)malloc(sizeof(char) * 4);
    config->instructions[0b00100000]->num_operands = 3;
    strcpy(config->instructions[0b00100000]->mnemonic, "SUB");
    config->instructions[0b00100000]->operands = (char **)malloc(sizeof(char *) * 3);
    config->instructions[0b00100000]->operands[0] = (char *)malloc(sizeof(char) * 2);
    strcpy(config->instructions[0b00100000]->operands[0], "B");
    config->instructions[0b00100000]->operands[1] = (char *)malloc(sizeof(char) * 2);
    strcpy(config->instructions[0b00100000]->operands[1], "A");
    config->instructions[0b00100000]->operands[2] = (char *)malloc(sizeof(char) * 2);
    strcpy(config->instructions[0b00100000]->operands[2], "A");
